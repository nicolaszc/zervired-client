...
export default function Steps({ className = '' }) {
  return (
        <div className={`flex flex-wrap items-center justify-center ${className}`}>
            <h2 className="px-6 text-center text-lg leading-snug bg-radial from-[#efefef] from-40% to-transparent dark:from-[#041f2f] dark:from-40% dark:to-transparent">
            ...
            <h1 className="w-full px-6 text-center text-3xl md:text-4xl font-semibold mt-1 mb-4 opacity-85">
              <span className='bg-radial from-[#efefef] from-40% to-transparent dark:from-[#041f2f] dark:from-40% dark:to-transparent'>En solo 3 simples pasos</span>
            </h1>

            <ol className='list-none p-0 mb-0 mt-8 text-sm flex flex-col items-center md:items-start justify-center md:flex-row'>
              <li className='flex flex-col items-center justify-start w-full md:mx-6 md:w-42 bg-radial from-[#efefef] from-40% to-transparent dark:from-[#041f2f] dark:from-40% dark:to-transparent'>
                <FontAwesomeIcon icon={faUserGear} className='text-4xl md:text-6xl me-2 md:me-0 mb-2 md:mb-4 opacity-80 block md:inline' />
              ...
              <li className='flex flex-col items-center justify-start w-full md:mx-6 md:w-42 bg-radial from-[#efefef] from-40% to-transparent dark:from-[#041f2f] dark:from-40% dark:to-transparent'>
                <FontAwesomeIcon icon={faAward} className='text-4xl md:text-6xl me-2 md:me-0 mb-2 md:mb-4 opacity-80' />
              ...
              <li className='bg-radial from-[#efefef] from-40% to-transparent dark:from-[#041f2f] dark:from-40% dark:to-transparent w-9'>
              ...
              <li className='flex flex-col items-center justify-start w-full md:mx-6 md:w-42 bg-radial from-[#efefef] from-40% to-transparent dark:from-[#041f2f] dark:from-40% dark:to-transparent'>
                <FontAwesomeIcon icon={faCreditCard} className='text-4xl md:text-6xl me-2 md:me-0 mb-2 md:mb-4 opacity-80' />
