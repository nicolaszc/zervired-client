...
export default function Footer() {
  return (
    <footer className="bg-(--primary-l) dark:bg-(--secondary-d) relative z-1" data-footer>
      <div className="mx-auto max-w-7xl px-6 pt-10 pb-24 md:pb-2 text-sm flex flex-col justify-between items-center dark:opacity-75">
