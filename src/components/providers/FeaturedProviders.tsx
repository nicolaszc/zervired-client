  ...
  return (
    <section className="mx-auto max-w-7xl px-6 pt-16 pb-8 relative z-10">
      <div className="mb-6 flex items-center justify-between">
        ...
        <span className="text-xs text-amber-600 dark:text-sky-500 uppercase tracking-wide bg-radial from-[#efefef] from-40% to-transparent dark:from-[#041f2f] dark:from-40% dark:to-transparent">
          Recomendados
        </span>
      </div>
